...
namespace motorbikemanage.mvc.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public CustomersController(motorbikemanagemvcContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CustomerName,Phonenumber,Email,Age")] Customer customer)
        {
            if (id != customer.Id)
            {
                return NotFound();
