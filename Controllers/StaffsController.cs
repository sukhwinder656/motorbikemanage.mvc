...
namespace motorbikemanage.mvc.Controllers
{
    public class StaffsController : Controller
    {
        ...
        public StaffsController(motorbikemanagemvcContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,Address,Date_of_Birth")] Staff staff)
        {
            if (id != staff.Id)
            {
                return NotFound();
